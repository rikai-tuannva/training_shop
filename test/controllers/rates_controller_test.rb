...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { product_id: @rate.product_id, star: @rate.star, user_id: @rate.user_id } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { product_id: @rate.product_id, star: @rate.star, user_id: @rate.user_id } }
